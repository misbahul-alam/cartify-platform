...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Misbahul Alam",
            "url": "https://misbahulalam.com",
            "email": "misbahulalam64@gmail.com"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
    ...
    "paths": {
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully authenticated. Returns access_token and refresh_token.",
                        "schema": {
                            "allOf": [
                                {
        ...
        "/auth/refresh-token": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid refresh token or request payload.",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/cart/items": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully updated item, returns updated cart.",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully added item, returns updated cart.",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/cart/items/{product_id}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully removed item, returns updated cart.",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/orders": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request payload or empty cart.",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/orders/all": {
            "get": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Forbidden: Admins/Sellers only.",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/orders/{id}/cancel": {
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid order ID format or cannot cancel.",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/orders/{id}/status": {
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid status or transitions.",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/payments/intent": {
            "post": {
                ...
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.CreatePaymentIntentResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "400": {
                        "description": "Invalid request payload or order already paid.",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/products/{id}/images/{image_id}/primary": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "dto.CreatePaymentIntentResponse": {
            "type": "object",
            "properties": {
                "client_secret": {
                    "type": "string"
